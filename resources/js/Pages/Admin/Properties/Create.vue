        ...
        <form @submit.prevent="submit" class="form">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        maxlength="2" 
                        required
                        :class="{ 'has-error': form.errors.state }"
                    >
                    <div v-if="form.errors.state" class="error">
                        {{ form.errors.state }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        type="text" 
                        required
                        :class="{ 'has-error': form.errors.zip_code }"
                    >
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input 
                        ...
                        min="0" 
                        required
                        :class="{ 'has-error': form.errors.bedrooms }"
                    >
                    <div v-if="form.errors.bedrooms" class="error">
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        min="0" 
                        required
                        :class="{ 'has-error': form.errors.bathrooms }"
                    >
                    <div v-if="form.errors.bathrooms" class="error">
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        min="1" 
                        required
                        :class="{ 'has-error': form.errors.square_feet }"
                    >
                    <div v-if="form.errors.square_feet" class="error">
                        {{ form.errors.square_feet }}
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    min="0" 
                    required
                    :class="{ 'has-error': form.errors.monthly_rent }"
                >
                <div v-if="form.errors.monthly_rent" class="error">
